...
Mlp1_11h_intDen = [data[5] for data in dot_data if data[1] == 'Mlp1' and data[2] == 11]
Mlp2_11h_intDen = [data[5] for data in dot_data if data[1] == 'Mlp2' and data[2] == 11]
print(f'Mlp1_11h = {np.mean(Mlp1_11h_intDen)} Mlp2_11h = {np.mean(Mlp2_11h_intDen)}')
